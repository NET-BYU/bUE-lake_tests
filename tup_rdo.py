...
class tup_rdo(gr.top_block):
    ...
    def __init__(self, message_str='TEST', mult_amp=0.5, tx_cr=1, tx_rx_bw=8000, tx_rx_mix_freq=1000, tx_rx_sf=7, tx_rx_sync_word=[0x12]):
...
def main(top_block_cls=tup_rdo, options=None):
    ...
    tb = top_block_cls(message_str=options.message_str, mult_amp=options.mult_amp, tx_cr=options.tx_cr, tx_rx_bw=options.tx_rx_bw, tx_rx_mix_freq=options.tx_rx_mix_freq, tx_rx_sf=options.tx_rx_sf)
