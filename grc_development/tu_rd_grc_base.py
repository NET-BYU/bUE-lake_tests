...
class tu_rd_grc_base(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "tu_rd_grc_base")
        ...
        self.connect((self.blocks_conjugate_cc_0, 0), (self.blocks_complex_to_float_1, 0))
...
def main(top_block_cls=tu_rd_grc_base, options=None):
