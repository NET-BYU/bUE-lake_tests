        ...
        try:
            ...
            if index == Command.REFRESH.value:
                ...
                start_time = survey.routines.datetime(
                    "What time do you want to run the test?: ",
                ...
                for bue in bues:
                    file_index = survey.routines.select(
                        f"What file would you like to run on {bUEs[str(bue)]}? ",
                        options=FILES,
                    )
                    file_name = FILES[file_index]
                    bue_test[bue] = file_name
                    parameters = survey.routines.input(
                        f"Enter parameters for {bUEs[str(bue)]}, {file_name} separated by a space: "
                    )
