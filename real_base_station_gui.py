...
class RealBaseStationGUI:
    ...
    def setup_left_panel(self, parent):
        ...
        self.listening_status_label = ttk.Label(
            status_frame,
            textvariable=self.listening_status_var,
    ...
    def update_display(self):
        ...
        try:
            ...
            if self._debug_counter % 10 == 0:  # Every 10 seconds
                logger.debug(
                    f"GUI Update - Connected bUEs: {len(self.base_station.connected_bues)}, "
    ...
    def update_tables(self):
        ...
        if (
            self.base_station
            and hasattr(self.base_station, "connected_bues")
            and len(self.base_station.connected_bues) > 1
            and hasattr(self.base_station, "bue_coordinates")
        ):
